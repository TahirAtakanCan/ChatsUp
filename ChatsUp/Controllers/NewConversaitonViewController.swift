...
class NewConversaitonViewController: UIViewController {
    ...
    private let tableView: UITableView = {
        ...
        table.isHidden = true
        table.register(NewConversationViewCell.self,
                       forCellReuseIdentifier: NewConversationViewCell.identifier)
        return table
    }()
...
extension NewConversaitonViewController: UITableViewDelegate, UITableViewDataSource {
